...
#[derive(Debug)]
pub struct ScopeManagerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ScopeManagerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ScopeManager processing");
    
    let mut processor = ScopeManagerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ScopeManagerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ScopeManagerProcessor::new(false);
